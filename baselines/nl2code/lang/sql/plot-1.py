...
from network import AttnDecoderRNN, DecoderRNN, EncoderRNN
from prepare_data import MAX_LENGTH, EOS_token, SOS_token, prepareData
...
def trainIters(
    encoder, decoder, n_iters, print_every=1000, plot_every=100, learning_rate=0.01, use_attention=True
):
    start = time.time()
    plot_losses = []
...
if __name__ == "__main__":
    ...
    if args.t == "train":
        ...
        translation, attentions = evaluate(
            encoder1, decoder1, "tu es probablement trop jeune pour le comprendre ."
        )
