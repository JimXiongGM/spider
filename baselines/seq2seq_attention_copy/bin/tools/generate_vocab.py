...
parser.add_argument(
    "--max_vocab_size", dest="max_vocab_size", type=int, help="Maximum number of tokens in the vocabulary"
)
parser.add_argument(
    "--downcase",
    dest="downcase",
...
logging.info("Found %d unique tokens with frequency > %d.", len(cnt), args.min_frequency)
