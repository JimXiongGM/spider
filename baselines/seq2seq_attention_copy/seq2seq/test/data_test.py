...
class ParallelDataProviderTest(tf.test.TestCase):
    ...
    def test_reading(self):
        ...
        self.assertEqual(set(item_keys), set(["source_tokens", "source_len", "target_tokens", "target_len"]))
        ...
        for item_dict in item_dicts_:
            ...
            np.testing.assert_array_equal(
                item_dict["target_tokens"], ["SEQUENCE_START"] + expected_target.split(" ") + ["SEQUENCE_END"]
            )
