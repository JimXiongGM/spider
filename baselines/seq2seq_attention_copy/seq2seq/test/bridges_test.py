...
from seq2seq.models.bridges import InitialStateBridge, PassThroughBridge, ZeroBridge
...
class BridgeTest(tf.test.TestCase):
    ...
    def setUp(self):
        ...
        self.encoder_outputs = EncoderOutput(
            outputs=tf.convert_to_tensor(value=np.random.randn(self.batch_size, 10, 16), dtype=tf.float32),
