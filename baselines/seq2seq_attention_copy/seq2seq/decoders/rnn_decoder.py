...
from seq2seq.encoders.rnn_encoder import _default_rnn_cell_params, _toggle_dropout
...
class RNNDecoder(Decoder, GraphModule, Configurable):
    ...
    def _build(self, initial_state, helper):
        ...
        outputs, final_state = dynamic_decode(
            decoder=self, output_time_major=True, impute_finished=False, maximum_iterations=maximum_iterations
        )
