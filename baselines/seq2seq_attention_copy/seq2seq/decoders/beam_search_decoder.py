...
class BeamSearchDecoder(RNNDecoder):
    ...
    def __init__(self, decoder, config):
        super(BeamSearchDecoder, self).__init__(decoder.params, decoder.mode, decoder.name)
    ...
    def step(self, time_, inputs, state, name=None):
        ...
        decoder_state = nest.map_structure(lambda x: tf.gather(x, bs_output.beam_parent_ids), decoder_state)
        decoder_output = nest.map_structure(lambda x: tf.gather(x, bs_output.beam_parent_ids), decoder_output)
