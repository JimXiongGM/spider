...
class ParallelTextAndMaskCopyingPipeline(ParallelTextAndMaskInputPipeline):
    ...
    def _get_copying_decoder(
        self, tokens_feature_name, length_feature_name, prepend_token, append_token, delimiter
    ):
...
class TFRecordInputPipeline(InputPipeline):
    ...
    def make_data_provider(self, **kwargs):
        ...
        items_to_handlers["source_tokens"] = tfexample_decoder.ItemHandlerCallback(
            ...
            func=lambda dict: splitter_source.decode(dict[self.params["source_field"]], ["source_tokens"])[0],
        )
        ...
        items_to_handlers["target_tokens"] = tfexample_decoder.ItemHandlerCallback(
            ...
            func=lambda dict: splitter_target.decode(dict[self.params["target_field"]], ["target_tokens"])[0],
        )
        ...
        return tf.contrib.slim.dataset_data_provider.DatasetDataProvider(
            dataset=dataset, shuffle=self.params["shuffle"], num_epochs=self.params["num_epochs"], **kwargs
        )
...
class ImageCaptioningInputPipeline(InputPipeline):
    ...
    def make_data_provider(self, **kwargs):
        ...
        items_to_handlers = {
            ...
            "target_ids": tfexample_decoder.Tensor(self.params["caption_ids_field"]),
            "target_tokens": tfexample_decoder.Tensor(self.params["caption_tokens_field"]),
