...
SpecialVocab = collections.namedtuple(
    "SpecialVocab", ["UNK", "SEQUENCE_START", "SEQUENCE_END", "COPY_WORD", "COPY_SCHEMA"]
)  # todo: how to check value
...
def read_vocab(filename):
    ...
    with gfile.GFile(filename) as file:  # Load vocabulary into memory
